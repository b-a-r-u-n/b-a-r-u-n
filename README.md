...
📚 **Content:** Sharing projects & development journey
...
`Redux Toolkit` · `React Router` · `Context API` · `REST APIs` · `Git & GitHub`

`MERN Applications` · `E-Commerce` · `Deployment` · `Hostinger`
...
<img src="https://skillicons.dev/icons?i=react" height="50" alt="React Router"/>
</a>

</p>

**Frontend:** React.js • JavaScript • HTML5 • CSS3 • Tailwind CSS • React Router
...
**Backend:** Node.js • Express.js • REST APIs • Authentication • API Architecture
